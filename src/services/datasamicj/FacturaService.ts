...
export const ByPer = async (): Promise<AxiosResponse<Factura[]>> =>
  await axios.get("/facturas/ByPer");

// Get Facturas por Período y Cliente
export const getfundbyper = async (): Promise<AxiosResponse<Factura[]>> =>
  await axios.get("/facturas/getfundbyper");

// Get Facturas por Período y Cliente
export const getsubsibyper = async (): Promise<AxiosResponse<Factura[]>> =>
  await axios.get("/facturas/getsubsibyper");
