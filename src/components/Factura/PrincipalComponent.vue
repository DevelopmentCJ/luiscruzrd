<template v-show="!cargando">
  <div>
    <!-- Spinner -->
    <!-- <h6>Número: {{ this.$store.state.user.numProcess }}</h6>
  <h6>Descripción: {{ this.$store.state.user.descProcess }}</h6> -->
    ...
    <div v-show="!cargando" class="general">
      ...
      <div v-if="showModal" class="modal">
        <div class="contenedor">
          ...
          <div class="contenido">
            ...
            <div @click="this.showModalMethod()" class="contenido">
              <Filters
      ...
      <div class="grid">
        ...
        > -->
          <h4>
            Facturas {{ this.$store.state.user.numProcess }} ({{
              this.$store.state.user.descProcess
            }})
            <i
              style="cursor:pointer"
              @click="this.showModalMethod()"
