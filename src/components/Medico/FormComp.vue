        ...
        <form>
          <fieldset>
              ...
              <div class="grid">
                ...
                <div>
                  <label
                    class="ta-l col-form-label col-form-label-sm"
                    for="diasConsulta"
                    >Dias de Consulta:</label
                  ><input
                    id="diasConsulta"
                    type="String"
                    v-model="medico.diasConsulta"
                    class="form-control"
                  />
                </div>
                <div>
                ...
                <div>
                  <label
                    class="ta-l col-form-label col-form-label-sm"
                    for="telSecretaria"
                    >Teléfono Secretaria:</label
                  ><input
                    id="telSecretaria"
                    type="String"
                    v-model="medico.telSecretaria"
                    class="form-control"
                  />
                </div>
                <div>
                  <label
                    class="ta-l col-form-label col-form-label-sm"
                    for="telConsultorio"
                    >Teléfono Consultorio:</label
                  ><input
                    id="telConsultorio"
                    type="String"
                    v-model="medico.telConsultorio"
                    class="form-control"
                  />
                </div>
                <div>
                ...
                <div>
                  <label
                    class="ta-l col-form-label col-form-label-sm"
                    for="preciosPrivado"
                    >Precio Privado:</label
                  ><input
                    id="preciosPrivado"
                    type="String"
                    v-model="medico.preciosPrivado"
                    class="form-control"
                  />
                </div>
                <div>
                  <label
                    class="ta-l col-form-label col-form-label-sm"
                    for="preciosDiferencia"
                    >Precio Diferencia:</label
                  ><input
                    id="preciosDiferencia"
                    type="String"
                    v-model="medico.preciosDiferencia"
                    class="form-control"
                  />
                </div>
                <div>
                  <label
                    class="ta-l col-form-label col-form-label-sm"
                    for="preciosProcedimientos"
                    >Precio Procedimiento:</label
                  ><input
                    id="preciosProcedimientos"
                    type="String"
                    v-model="medico.preciosProcedimientos"
                    class="form-control"
                  />
                </div>
                <div>
              ...
              <div class="grid">
                <div>
                  ...
                  ><input
                    ...
                    v-model="medico.mecanismoLesion"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    ...
                    v-model="medico.tiempoEvolucion"
                    class="form-control"
                  />
                </div>
              </div> -->
              ...
              <div class="grid">
                <div>
                  ...
                  ><input
                    ...
                    v-model="medico.elevacionAnteriorActiva"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    ...
                    v-model="medico.elevacionAnteriosPasiva"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    ...
                    v-model="medico.rotacionInterna"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    ...
                    v-model="medico.rotacionExterna"
                    class="form-control"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  ><input
                    ...
                    v-model="medico.acromioClavicular"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    ...
                    v-model="medico.inestabilidadAnterior"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><input
                    ...
                    v-model="medico.inestabilidadPosterior"
                    class="form-control"
                  />
                </div>
              </div> -->
              ...
              <div class="grid">
                <div>
                  ...
                  ><textarea
                    ...
                    v-model="medico.estudiosSolicitados"
                    class="form-control"
                  />
                </div>
              </div> -->
              ...
              <div class="grid">
                <div>
                  ...
                  ><textarea
                    ...
                    v-model="medico.diagnosticoPresuntivo"
                    class="form-control"
                  />
                </div>
                <div>
                  ...
                  ><textarea
                    ...
                    v-model="medico.diagnosticoImagen"
                    class="form-control"
                  />
                </div>
              </div> -->
            ...
            <div class="grid-consultas">
              <!-- <ul>
                <li
                  v-for="(consulta, index) in medico.consultas"
                  :key="index"
                >
                  <a href="#">
                    <h2>
            ...
            <button
              ...
              :disabled="
                !medico.edificio ||
                  ...
                  !medico.secretaria ||
                  !medico.precios ||
                  !medico.telSecretaria ||
                  !medico.telConsultorio ||
                  !medico.procedimientos ||
                  !medico.preciosPrivado ||
                  !medico.preciosDiferencia ||
                  !medico.preciosProcedimientos ||
                  !medico.notas
              "
            >
            ...
            <!-- <button
              ...
              @click="this.$router.push(`/medicos2/${medico._id}`)"
            >
...
import {
  ...
  getMedico,
  updateMedico,
} from "@/services/luiscruzrd/Medico";
